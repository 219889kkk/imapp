...
class StrRes {
  ...
  static String get miniApps => 'miniApps'.tr;
  ...
  static String get earnMoney => 'earnMoney'.tr;

  static String get earnComingSoon => 'earnComingSoon'.tr;

  static String get accountSetup => 'accountSetup'.tr;

  static String get mineSectionAccount => 'mineSectionAccount'.tr;

  static String get mineSectionSettings => 'mineSectionSettings'.tr;

  static String get mineSectionMore => 'mineSectionMore'.tr;

  static String get chatNotificationSetup => 'chatNotificationSetup'.tr;

  static String get privacySecuritySetup => 'privacySecuritySetup'.tr;

  static String get appearanceLanguageSetup => 'appearanceLanguageSetup'.tr;

  static String get msgNotification => 'msgNotification'.tr;

  static String get callNotification => 'callNotification'.tr;

  static String get messageSound => 'messageSound'.tr;

  static String get notificationShowDetail => 'notificationShowDetail'.tr;

  static String get newMessageHint => 'newMessageHint'.tr;

  static String get voiceCallInviteHint => 'voiceCallInviteHint'.tr;

  static String get videoCallInviteHint => 'videoCallInviteHint'.tr;
  ...
  static String get noUnreadMessage => 'noUnreadMessage'.tr;
  ...
  static String get readDetailSdkHint => 'readDetailSdkHint'.tr;
  ...
  static String get themeSetup => 'themeSetup'.tr;
  ...
  static String get themeColor => 'themeColor'.tr;

  static String get themeColorCustom => 'themeColorCustom'.tr;

  static String get themeColorBlue => 'themeColorBlue'.tr;

  static String get themeColorGreen => 'themeColorGreen'.tr;

  static String get themeColorOrange => 'themeColorOrange'.tr;

  static String get themeColorPink => 'themeColorPink'.tr;

  static String get themeColorPurple => 'themeColorPurple'.tr;

  static String get themeColorTeal => 'themeColorTeal'.tr;
  ...
  static String get burnDuration => 'burnDuration'.tr;

  static String get burnDuration30Seconds => 'burnDuration30Seconds'.tr;

  static String get burnDuration1Minute => 'burnDuration1Minute'.tr;

  static String get burnDuration5Minutes => 'burnDuration5Minutes'.tr;

  static String get burnDuration1Hour => 'burnDuration1Hour'.tr;
  ...
  static String get chatFolders => 'chatFolders'.tr;

  static String get allConversations => 'allConversations'.tr;

  static String get unreadConversations => 'unreadConversations'.tr;

  static String get singleChats => 'singleChats'.tr;

  static String get groupChats => 'groupChats'.tr;

  static String get setConversationTags => 'setConversationTags'.tr;

  static String get createTag => 'createTag'.tr;

  static String get renameTag => 'renameTag'.tr;

  static String get enableChatFolders => 'enableChatFolders'.tr;

  static String get autoCategories => 'autoCategories'.tr;
  ...
  static String get gotIt => 'gotIt'.tr;
  ...
  static String get momentPublishHint => 'momentPublishHint'.tr;

  static String get momentCommentHint => 'momentCommentHint'.tr;

  static String get signature => 'signature'.tr;

  static String get setSignature => 'setSignature'.tr;

  static String get signaturePlaceholder => 'signaturePlaceholder'.tr;

  static String get signatureNotSet => 'signatureNotSet'.tr;
  ...
  static String get friendsVisible => 'friendsVisible'.tr;
  ...
  static String get voiceRecordFailed => 'voiceRecordFailed'.tr;
