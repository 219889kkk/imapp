const Map<String, String> zh_CN = {
  ...
  "offlineCallMessage": "有人邀请你进行通话",
  "voiceCallNotificationTitle": "语音通话",
  "videoCallNotificationTitle": "视频通话",
  "logoutHint": "您确定要退出登录吗？",
  "myInfo": "我的信息",
  "workingCircle": "圈子",
  "accountSetup": "偏好设置",
  "mineSectionAccount": "账号",
  "mineSectionSettings": "设置",
  "mineSectionMore": "更多",
  "chatNotificationSetup": "聊天与通知",
  "privacySecuritySetup": "隐私与安全",
  "appearanceLanguageSetup": "外观与语言",
  "msgNotification": "消息通知",
  "callNotification": "通话通知",
  "messageSound": "消息提示音",
  "notificationShowDetail": "通知显示详情",
  "newMessageHint": "你收到一条新消息",
  "voiceCallInviteHint": "邀请你语音通话",
  "videoCallInviteHint": "邀请你视频通话",
  "aboutUs": "关于我们",
  "logout": "退出登录",
  "qrcode": "二维码",
  ...
  "hasReadCount": "已读(%s)",
  "unreadCount": "未读(%s)",
  "readDetailSdkHint": "当前 SDK 版本暂不支持查看每位成员的已读状态，仅展示群成员列表。",
  "me": "我",
  "empty": "暂无数据",
  "retry": "重试",
  "newFriend": "新的好友",
  ...
  "scanHint": "扫描二维码名片",
  "addFriend": "添加好友",
  "addFriendHint": "通过用户名/用户ID搜索添加",
  "createGroup": "创建群聊",
  "createGroupHint": "创建群聊，全面使用OpenIM",
  "addGroup": "添加群聊",
  "addGroupHint": "向管理员或群聊成员询问ID",
  "searchIDAddFriend": "搜索用户名/ID添加好友",
  ...
  "burnDuration": "阅后即焚时间",
  "burnDuration30Seconds": "30秒",
  "burnDuration1Minute": "1分钟",
  "burnDuration5Minutes": "5分钟",
  "burnDuration1Hour": "1小时",
  "timeSet": "时间设置",
  ...
  'chatFolders': '聊天文件夹',
  'allConversations': '全部',
  'unreadConversations': '未读',
  'singleChats': '单聊',
  'groupChats': '群聊',
  'setConversationTags': '设置标签',
  'createTag': '新建标签',
  'renameTag': '重命名标签',
  'enableChatFolders': '启用聊天文件夹',
  'autoCategories': '自动分类',
  'addMember': '添加',
  'delMember': '移除',
  'groupOwner': '群主',
  ...
  "whoCanWatch": "谁可以看",
  "momentPublishHint": "这一刻的想法...",
  "momentCommentHint": "评论",
  "signature": "个性签名",
  "setSignature": "点击设置签名",
  "signaturePlaceholder": "填写个性签名",
  "signatureNotSet": "未设置",
  ...
  'callFail': '你无法呼叫该用户',
  'search_by_phone_and_uid': '通过用户名/用户ID/手机号搜索',
  'lastOnlineTime': '上次在线 %s',
  ...
  'androidCallPermTitle': '开启来电提示权限',
  'androidCallPermBody':
      '锁屏来电需要保持航讯在后台可运行。下面只列出这台手机还需要开的项：\n\n%s',
  'androidCallPermGoSettings': '去设置',
  'androidCallPermLater': '稍后',
  'androidCallPermNotification': '通知权限',
  'androidCallPermFullScreen': '全屏来电提示',
  'androidCallPermOverlay': '悬浮窗',
  'androidCallPermBattery': '忽略电池优化',
  'androidCallPermHibernation': '关闭「暂停闲置应用的活动」',
  'androidCallPermAutostart': '允许自启动与后台运行',
  'androidCallPermAutostartXiaomi': '打开自启动、后台运行（省电策略选「无限制」）',
  'androidCallPermAutostartHuawei': '打开自动启动 / 手动管理',
  'androidCallPermAutostartOppo': '允许自启动与后台运行',
  'androidCallPermAutostartVivo': '允许自启动、后台高耗电',
  'androidCallPermAutostartMeizu': '允许后台运行',
  'androidCallPermOpenHibernation': '去关闭闲置暂停',
  'androidCallPermOpenAutostart': '去自启动设置',
  'monday': '星期一',
  'tuesday': '星期二',
  'wednesday': '星期三',
  'thursday': '星期四',
