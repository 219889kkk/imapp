const Map<String, String> en_US = {
  ...
  "account": "Username",
  "plsEnterAccount": "Please enter your username",
  ...
  "offlineCallMessage": "Someone is calling you",
  "voiceCallNotificationTitle": "Voice Call",
  "videoCallNotificationTitle": "Video Call",
  "logoutHint": "Are you sure you want to log out?",
  "myInfo": "My Info",
  "workingCircle": "Circle",
  "accountSetup": "Preferences",
  "mineSectionAccount": "Account",
  "mineSectionSettings": "Settings",
  "mineSectionMore": "More",
  "chatNotificationSetup": "Chat & Notifications",
  "privacySecuritySetup": "Privacy & Security",
  "appearanceLanguageSetup": "Appearance & Language",
  "msgNotification": "Message Notifications",
  "callNotification": "Call Notifications",
  "messageSound": "Message Sound",
  "notificationShowDetail": "Show Message Preview",
  "newMessageHint": "You received a new message",
  "voiceCallInviteHint": " invites you to a voice call",
  "videoCallInviteHint": " invites you to a video call",
  "aboutUs": "About Us",
  "logout": "Log Out",
  "qrcode": "QR Code",
  ...
  "readDetailSdkHint": "The current SDK version does not support per-member read status. Showing group member list only.",
  "me": "Me",
  "empty": "No data",
  "retry": "Retry",
  ...
  "burnDuration30Seconds": "30 seconds",
  "burnDuration1Minute": "1 minute",
  "burnDuration5Minutes": "5 minutes",
  "burnDuration1Hour": "1 hour",
  ...
  'singleChats': 'Direct',
  'groupChats': 'Groups',
  'setConversationTags': 'Set Tags',
  'createTag': 'New Tag',
  'renameTag': 'Rename Tag',
  'enableChatFolders': 'Enable Chat Folders',
  ...
  "momentPublishHint": "What's on your mind...",
  "momentCommentHint": "Comment",
  "signature": "Signature",
  "setSignature": "Tap to set signature",
  "signaturePlaceholder": "Enter your signature",
  "signatureNotSet": "Not set",
  "remindWhoToWatch": "Remind who to watch",
  "public": "Public",
  "everyoneCanSee": "Everyone can see",
  "friendsVisible": "Friends can see",
  ...
  'search_by_phone_and_uid': 'Search by username / user ID / phone',
  'lastOnlineTime': 'Last online %s',
  ...
  'androidCallPermTitle': 'Enable call alert permissions',
  'androidCallPermBody':
      'Lock-screen calls need HangXun running in the background. Only items still needed on this phone are listed:\n\n%s',
  'androidCallPermGoSettings': 'Open settings',
  'androidCallPermLater': 'Later',
  'androidCallPermNotification': 'Notifications',
  'androidCallPermFullScreen': 'Full-screen incoming calls',
  'androidCallPermOverlay': 'Display over other apps',
  'androidCallPermBattery': 'Ignore battery optimizations',
  'androidCallPermHibernation': 'Turn off “Pause app activity if unused”',
  'androidCallPermAutostart': 'Allow autostart and background running',
  'androidCallPermAutostartXiaomi': 'Enable autostart and background (battery: No restrictions)',
  'androidCallPermAutostartHuawei': 'Enable auto-launch / manage manually',
  'androidCallPermAutostartOppo': 'Allow autostart and background running',
  'androidCallPermAutostartVivo': 'Allow autostart and high background battery use',
  'androidCallPermAutostartMeizu': 'Allow background running',
  'androidCallPermOpenHibernation': 'Disable unused-app pause',
  'androidCallPermOpenAutostart': 'Open autostart settings',
  'monday': 'Monday',
  'tuesday': 'Tuesday',
  'wednesday': 'Wednesday',
  'thursday': 'Thursday',
