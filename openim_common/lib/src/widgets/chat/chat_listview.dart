...
class ChatListView extends StatefulWidget {
  const ChatListView({
    ...
    this.onScrollToTop,
    this.initialScrollToBottomLoadMore = true,
    this.autoLoadInitialMessages = true,
  }) : super(key: key);
  ...
  final bool initialScrollToBottomLoadMore;
  final bool autoLoadInitialMessages;
...
class _ChatListViewState extends State<ChatListView> {
  ...
  @override
  void initState() {
    _scrollToBottomLoadMore = widget.initialScrollToBottomLoadMore;
    if (widget.autoLoadInitialMessages) {
      _onScrollToBottomLoadMore();
    }
