        ...
        child: null == _showName
            ? (showDefaultAvatar
                ? FaIcon(
                    ...
                    color: Styles.ts_FFFFFF_14sp.color,
                    size: _avatarSize / 2,
                  )
                : null)
  ...
  Widget _nineGridRow({
    ...
    Widget nineGridLine({
      ...
      double? height,
        ...
        Container(height: height, width: width, color: Styles.c_FFFFFF);
    var list = <Widget>[];
...
class RedDotView extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Styles.c_FF381F.withOpacity(.15),
              offset: Offset(1.15.w, 1.15.h),
              blurRadius: 57.58.r,
            ),
            BoxShadow(
              color: Styles.c_FF381F.withOpacity(.1),
              offset: Offset(2.3.w, 2.3.h),
              blurRadius: 11.52.r,
            ),
            BoxShadow(
              color: Styles.c_FF381F.withOpacity(.05),
