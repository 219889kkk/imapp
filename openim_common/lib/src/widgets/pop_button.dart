...
class PopButton extends StatelessWidget {
  ...
  static Widget buildMenuIcon(IconData icon, {Color? color}) {
    return SizedBox(
      width: 22.w,
      height: 22.w,
      child: Icon(
  ...
  static Widget buildMenuImage(String asset, {Color? color}) {
    ...
    return CopyCustomPopupMenu(
      ...
      menuBuilder: () => _buildPopBgView(
        child: Column(
          ...
          children: menus.map((e) => _buildPopItemView(e, showLine: false)).toList(),
        ),
      ),
    );
  }
