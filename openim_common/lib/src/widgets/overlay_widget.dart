    ...
    _toastOverlayEntry = OverlayEntry(
      builder: (BuildContext context) => DialogContainer(
        ...
        child: Container(
          ...
          child: Text(
            text,
            style: Styles.ts_FFFFFF_14sp.copyWith(color: Styles.toastText),
          ),
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return FadeTransition(
      ...
      child: GestureDetector(
        ...
        child: Material(
          color: widget.backgroundColor ?? Styles.scrim.withAlpha(150),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: FadeTransition(
          ...
          child: Material(
            color: Styles.scrim.withAlpha(150),
            child: Column(
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTapDown: (details) {
        ...
        double? left = widget.expandFromRight
            ? rect.right - contentWidth
            : rect.left + popupMenuButtonWidth / 2 - contentWidth / 2;
        ...
        final menuAlignment = widget.expandFromRight
            ? (reverse ? Alignment.bottomRight : Alignment.topRight)
