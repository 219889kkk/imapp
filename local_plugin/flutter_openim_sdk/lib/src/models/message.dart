...
class GroupHasReadInfo {
  ...
  /// Group member count used for unread calculation on the client.
  ...
  GroupHasReadInfo.fromJson(Map<String, dynamic> json) {
    ...
    hasReadUserIDList = json['hasReadUserIDList'] == null
        ? null
        : (json['hasReadUserIDList'] as List).map((e) => '$e').toList();
