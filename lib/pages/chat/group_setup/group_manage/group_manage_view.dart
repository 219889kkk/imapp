      ...
      body: Obx(
        () => Column(
          children: [
            ...
            _buildItemView(
              text: StrRes.setAsAdmin,
              onTap: logic.setAdminRole,
              showRightArrow: true,
            ),
            _buildItemView(
              text: StrRes.setMute,
              onTap: logic.setMemberMute,
              showRightArrow: true,
            ),
            _buildItemView(
              text: StrRes.muteAllMember,
              switchOn: logic.groupMuted.value,
              showSwitchButton: true,
              onChanged: logic.toggleGroupMute,
            ),
            _buildItemView(
              text: StrRes.joinGroupSet,
              value: logic.verificationLabel,
              showRightArrow: true,
              isBottomRadius: true,
              onTap: logic.setGroupVerification,
            ),
          ],
        ),
      ),
