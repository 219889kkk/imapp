      ...
      body: Obx(() => SingleChildScrollView(
            child: Column(
              children: [
                ...
                if (logic.isJoinedGroup.value) 10.verticalSpace,
                if (logic.isJoinedGroup.value)
                  _buildItemView(
                    text: StrRes.groupAc,
                    value: logic.groupInfo.value.notification,
                    showRightArrow: true,
                    isTopRadius: true,
                    onTap: logic.editAnnouncement,
                  ),
                if (logic.isJoinedGroup.value && logic.isOwner)
                  _buildItemView(
