            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  if (!logic.isMyself &&
                      logic.onlineStatusDesc.value.isNotEmpty)
                    Padding(
                      padding: EdgeInsets.only(top: 4.h),
                      child: logic.onlineStatusDesc.value.toText
                        ..style = (logic.onlineStatus.value
  ...
  Widget _buildButtonGroup() => Positioned(
        ...
        child: ClipRRect(
          child: BackdropFilter(
            ...
            child: Container(
              color: Styles.insetBackground.withOpacity(.3),
