              ...
              children: [
                ...
                _buildCornerBgView(
                  children: [
                    ...
                    _buildItemView(
                      label: StrRes.signature,
                      value: _signatureText(imLogic.userInfo.value.signature),
...
String _signatureText(String? signature) {
  final value = IMUtils.emptyStrToNull(signature);
  return value ?? StrRes.signatureNotSet;
}
